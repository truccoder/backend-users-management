In this chapter, you are asked to design a 
news feed system. What is news feed? According to
the Facebook help page,
...
![Figure11-3.png](../assets/Figure11-3.png)
...
![Figure11-4.png](../assets/Figure11-4.png)

Web servers
Besides communicating with clients, web servers enforce authentication and rate-limiting.
Only users signed in with valid auth
_
token are allowed to make posts. The system limits the
...
![Figure11-5.png](../assets/Figure11-5.png)
...
![Figure11-6.png](../assets/Figure11-6.png)

Newsfeed retrieval deep dive
Figure 11-7 illustrates the detailed design for news feed retrieval.

![Figure11-7.png](../assets/Figure11-7.png)
...
![Figure11-8.png](../assets/Figure11-8.png)
